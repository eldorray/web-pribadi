<x-layouts.frontend :settings="$settings" :socialLinks="$socialLinks" title="Contact | {{ $settings['site_name'] ?? 'Architect.folio' }}">

    <div class="pt-32 pb-24 px-6 md:px-12 lg:px-24 max-w-7xl mx-auto">
        <!-- Hero Section -->
        <section class="mb-20">
            <h1 class="font-headline text-6xl md:text-8xl font-black tracking-tighter mb-6 text-on-surface">
                Let's Build <br/>
                <span class="text-primary italic">Together.</span>
            </h1>
            <p class="max-w-2xl text-lg md:text-xl text-on-surface-variant leading-relaxed">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div class="lg:col-span-8 bg-surface-container-lowest rounded-xl p-8 md:p-12 shadow-ambient">
            ...
            <div class="lg:col-span-4 space-y-8">
                ...
                <!-- Connect Card -->
                <div class="bg-primary text-on-primary rounded-xl p-8 shadow-[0_20px_40px_rgba(0,62,199,0.15)]">
                ...
                <div class="bg-surface-container-high rounded-xl p-8">
                    ...
                    <a class="text-xl font-headline font-bold text-on-surface hover:text-primary transition-colors" href="mailto:{{ $settings['contact_email'] ?? '' }}">
                        {{ $settings['contact_email'] ?? 'hello@architect.folio' }}
                    </a>
                </div>
            </div>
        </div>
        ...
        <section class="mt-24 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div class="space-y-6 md:pl-12">
                ...
                <h2 class="font-headline text-4xl font-bold leading-tight">{{ $settings['contact_availability'] ?? '' }}</h2>
